...
extern "C" {
	NSLOADER_API TestClass* __stdcall NSVR_Create() { return new TestClass(); }
	...
	NSLOADER_API bool __stdcall NSVR_Load(TestClass* ptr, LPSTR param, int fileType) { return ptr->Load(param, fileType); }
	...
	NSLOADER_API bool NSVR_InitializeFromFilesystem(TestClass* ptr, LPSTR path) { return ptr->InitializeFromFilesystem(path); }
